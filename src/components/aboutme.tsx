...
export default function AboutMe() {
    return (
        <div className="container d-flex flex-column justify-content-center text-center mt-5">
            ...
            <h2 className='textWhiteSmall'>Sobre mim</h2>
            <p className="textGraySmall">Desenvolvedor Full Stack com mais de 2 anos de experiência em Front End e desenvolvimento Mobile em React Native.
